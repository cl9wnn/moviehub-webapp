...
export const getRecommendationMoviesByUser = async (): Promise<RecommendationMovieResponse[]> => {
  try {
    const response = await api.get<RecommendationMovieResponse[]>(`/recommendations/user-movies`);
