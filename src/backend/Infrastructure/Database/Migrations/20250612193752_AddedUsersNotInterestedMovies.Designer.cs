...
namespace Infrastructure.Database.Migrations
{
    ...
    [Migration("20250612193752_AddedUsersNotInterestedMovies")]
    partial class AddedUsersNotInterestedMovies
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieEntityUserEntity", b =>
                {
                    b.Property<Guid>("UsersWatchListId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("WatchListId")
                        .HasColumnType("uuid");

                    b.HasKey("UsersWatchListId", "WatchListId");
            ...
            modelBuilder.Entity("MovieEntityUserEntity1", b =>
                {
                    b.Property<Guid>("NotInterestedMoviesId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("UsersNotInterestedId")
                        .HasColumnType("uuid");

                    b.HasKey("NotInterestedMoviesId", "UsersNotInterestedId");

                    b.HasIndex("UsersNotInterestedId");

                    b.ToTable("NotInterestedMovies", (string)null);
                });
            ...
            modelBuilder.Entity("MovieEntityUserEntity", b =>
                {
                    b.HasOne("Infrastructure.Database.Entities.UserEntity", null)
                        .WithMany()
                        .HasForeignKey("UsersWatchListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MovieEntityUserEntity1", b =>
                {
                    b.HasOne("Infrastructure.Database.Entities.MovieEntity", null)
                        .WithMany()
                        .HasForeignKey("NotInterestedMoviesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Infrastructure.Database.Entities.UserEntity", null)
                        .WithMany()
                        .HasForeignKey("UsersNotInterestedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
